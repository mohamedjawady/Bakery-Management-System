...
import { Loader2, User, Truck, Key } from "lucide-react"
      ...
      <div className="flex flex-col gap-6">
        <div>
          ...
          <p className="text-muted-foreground">
            Gérez vos informations personnelles et vos paramètres de livraison
          </p>
        </div>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Détails de votre véhicule de livraison
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  placeholder="Ex: Camionnette, Vélo, Scooter"
                />
              </div>
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  onChange={(e) => setProfile({ ...profile, vehicleRegistration: e.target.value })}
